...
export default function SetupPage() {
  ...
  return (
    <main className="flex min-h-[calc(100vh-128px)] flex-col items-center justify-center gap-6 px-4 pt-24">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-white/60">
                    ...
                    optimization. You maintain full control of your assets at
                    all times.
                  </p>
